    ...
    >
      <div className="z-0 relative w-full h-full">
        <Image
          ...
          placeholder="blur"
          src={post?.image}
          sizes="(max-width 490px) 100vw, (max-width: 768px) 75vw, (max-width: 1068px) 50vw, 33vw"
    ...
    <section className="pt-3 pb-10">
      <div className="flex items-center gap-3">
        ...
        <p className="text-sm ">
          ...
          Exercitationem ut excepturi temporibus vero dolorum velit doloribus
          iusto delectus corrupti, libero, distinctio reprehenderit earum
          necessitatibus aliquam repudiandae harum nisi, iure porro.
        </p>
      </div>
      {/* flex option */}
      ...
      <p className="text-sm ">
        ...
        rerum. Quo hic ipsum expedita praesentium, inventore saepe eius, ducimus
        reprehenderit nemo quisquam possimus. Quaerat voluptates voluptatem
        maiores velit quae?
      </p>
    </section>
  );
